...
$sindicosMoradores = $sindicoDao->findMoradorAll();
?>
...
<body>
                    ...
                    <fieldset>
                        ...
                        <form method="post" action="index.php"><!-- Form Geral -->
                            <div class="form-row"><!-- Div1 -->
                                <div class="col-md-12 mb-3" id="div_sindicosMoradores"><!-- Nome do Morador -->
    ...
    <script src="../assets/js/ajax_sindicoMorador.js"></script>
</body>
</html> 
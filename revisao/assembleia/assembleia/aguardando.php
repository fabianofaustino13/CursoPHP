    ...
    <!-- Início do container -->
        <div class="containerMenuDireita">
            ...
            <div class="row"  style="margin-top:5%;">
                <div class="col-md-12 mb-3">
                    <legend>Morador, aguarde a sua liberação no sistema</legend>
                    <form method="post" action="checaAssembleia.php"><!-- Form -->                    
                        <div class="form-row"><!-- Div1 -->                        
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input disabled="disabled" type="radio" id="<?=$tipoAssembleia->getNome();?>" name="tipoAssembleia" value=<?=$tipoAssembleia->getId();?> <?=$tipoAssembleia->getId() == $assembleia->getTipoAssembleia()->getId() ? 'checked': "";?> class="custom-control-input" <?php if ($tipoAssembleia->getId() == 1):?> checked <?php endif; ?> required/>
                            ...
                            <div class="col-9"><!-- Nome da assembléia -->
                                ...
                                <input disabled="disabled" type="hidden" name="id" value="<?=$assembleia->getId();?>">
                            </div>
                            <div class="col-3">
                                <label for="data" class="required">Data da Assembléia</label>
                            </div>
                            <div class="col-md-9 mb-3">
                                <input disabled="disabled" type="text" class="form-control" id="nome" name="nome" value="<?=$assembleia->getNome();?>" maxlength="100" placeholder="Assembléia Ordinária" />
                            ...
                            <div class="col-md-3 mb-3"><!-- Data da assembléia -->
                                <input disabled="disabled" type="date" class="form-control" id="data" name="data" value="<?=$assembleia->getData();?>" />
                        ...
                        <div class="form-group">
                            <button disabled="disabled" type="submit" class="btn btn-primary btn-block" name="salvar" value="salvar" >Salvar</button>

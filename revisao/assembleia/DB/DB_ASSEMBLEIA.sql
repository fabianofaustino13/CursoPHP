...
CREATE TABLE IF NOT EXISTS TB_MORADORES(
    ...
    MOR_STATUS BOOLEAN,
    FK_MOR_APA SMALLINT(4) UNSIGNED ZEROFILL NOT NULL,
    ...
    CONSTRAINT FK_APA_MOR FOREIGN KEY(FK_MOR_APA) REFERENCES TB_APARTAMENTOS(PK_APA),
    CONSTRAINT FK_PER_MOR FOREIGN KEY(FK_MOR_PER) REFERENCES TB_PERFIS(PK_PER)
);

INSERT INTO TB_MORADORES 
	(MOR_NOME, MOR_CPF, MOR_LOGIN, MOR_SENHA, MOR_STATUS, FK_MOR_PER, FK_MOR_APA) 
VALUES 
    ('CARLA AGUIAR FALCAO', '11111111111', 'CAF', '111', TRUE, 1, 1),
    ('MARIA DA CONCEIÇÃO AGUIAR', '22222222222', 'MCA', '222', FALSE, 2, 100),
    ('GEORGE ANDERSON', '33333333333', 'GA', '333', FALSE, 4, 50),
    ('GEORGE WANDEMOND', '44444444444', 'GW', '444', FALSE, 4, 110);
